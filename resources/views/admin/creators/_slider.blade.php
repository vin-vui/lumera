                ...
                <div class="pointer-events-auto w-screen max-w-5xl">
                    ...
                    <div class="h-full overflow-y-auto bg-white" x-description="Slide-over panel, show/hide based on slide-over state.">
                        ...
                        <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4 min-h-screen">
                            ...
                            <div class="mb-8">
                                <x-jet-label for="email" value="Email de contact" />
                                <x-jet-input id="email" class="block mt-1 w-full" type="text" name="email" wire:model="email" />
                            ...
                            <div class="mb-8 flex gap-4">
                                <div class="grow">
                                    ...
                                    <div class="flex gap-2 items-center">
                                        ...
                                        <x-jet-input id="sn_facebook" class="block mt-1 w-full" type="url" placeholder="https://www.facebook.fr/example" pattern="https://.*" name="sn_facebook" wire:model="sn_facebook" />
                                        @error('sn_facebook') <span class="text-red-500">{{ $message }}</span>@enderror
                                    </div>
                                    <div class="flex gap-2 items-center">
                                ...
                                <div class="">
                                    <x-jet-label for="tn_tiktok" value="Nombre d'abonnés" />
                                    <div class="">
                                        <x-jet-input id="tn_tiktok" class="block mt-1 w-full" type="number" min="0" name="tn_tiktok" wire:model="tn_tiktok" />
                                        @error('tn_tiktok') <span class="text-red-500">{{ $message }}</span>@enderror
                                    </div>
                                    <div class="">
                                        <x-jet-input id="tn_snapchat" class="block mt-1 w-full" type="number" min="0" name="tn_snapchat" wire:model="tn_snapchat" />
                                        @error('tn_snapchat') <span class="text-red-500">{{ $message }}</span>@enderror
                                    </div>
                                    <div class="">
                                        <x-jet-input id="tn_instagram" class="block mt-1 w-full" type="number" min="0" name="tn_instagram" wire:model="tn_instagram" />
                                        @error('tn_instagram') <span class="text-red-500">{{ $message }}</span>@enderror
                                    </div>
                                    <div class="">
                                        <x-jet-input id="tn_youtube" class="block mt-1 w-full" type="number" min="0" name="tn_youtube" wire:model="tn_youtube" />
                                        @error('tn_youtube') <span class="text-red-500">{{ $message }}</span>@enderror
                                    </div>
                                    <div class="">
                                        <x-jet-input id="tn_linkedin" class="block mt-1 w-full" type="number" min="0" name="tn_linkedin" wire:model="tn_linkedin" />
                                        @error('tn_linkedin') <span class="text-red-500">{{ $message }}</span>@enderror
                                    </div>
                                    <div class="">
                                        <x-jet-input id="tn_facebook" class="block mt-1 w-full" type="number" min="0" name="tn_facebook" wire:model="tn_facebook" />
                                        @error('tn_facebook') <span class="text-red-500">{{ $message }}</span>@enderror
                                    </div>
                                    <div class="">
                                        <x-jet-input id="tn_twitter" class="block mt-1 w-full" type="number" min="0" name="tn_twitter" wire:model="tn_twitter" />
                                        @error('tn_twitter') <span class="text-red-500">{{ $message }}</span>@enderror
                                    </div>
                                    <div class="">
                                        <x-jet-input id="tn_twitch" class="block mt-1 w-full" type="number" min="0" name="tn_twitch" wire:model="tn_twitch" />
                                        @error('tn_twitch') <span class="text-red-500">{{ $message }}</span>@enderror
                                    </div>
                                </div>
                            </div>
