    ...
    <main class="no-bg">
        <section class="t-page">
            <div class="g-row align-center-start">
                <div class="sm-column-12 lg-column-8 m-content">
                    <h1>Conditions générales</h1>
                    <p>Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement juridique des modalités de mise à disposition du site et des services par LUMERA et de définir les conditions d’accès et d’utilisation des services par « l'Utilisateur ».</p>
                    <p>Les présentes CGU sont accessibles sur le site à la rubrique «CGU».</p>

                    <h2 class="a-h3">Article 1 : Les mentions légales</h2>
                    <p>L'édition du site https://lumera.social/ est assurée par la Société SASU LUMERA au capital de 1000 euros, immatriculée au RCS de NIORT sous le numéro 877648717, dont le siège social est situé au 58 Route de la Maclière Sainte Ouenne 79220</p>
                    <ul class="mgb-2">
                        <li class="text-cgraydark">Numéro de téléphone : 0602098910</li>
                        <li class="text-cgraydark">Adresse e-mail : clement@lumera.social</li>
                    ...
                    <p>Le site internet propose les services suivants : Campagne d'influence marketing, CM, Gestion de la communication globale des entreprises sur les réseaux</p>
                    ...
                    <h2 class="a-h3">ARTICLE 3 : Collecte des données</h2>
                    ...
                    <h2 class="a-h3">ARTICLE 4 : Propriété intellectuelle</h2>
                    ...
                    <h2 class="a-h3">ARTICLE 5 : Responsabilité</h2>
                    <p>Les sources des informations diffusées sur le site https://lumera.social/ sont réputées fiables mais le site ne garantit pas qu’il soit exempt de défauts, d’erreurs ou d’omissions.</p>
                    <p>Les informations communiquées sont présentées à titre indicatif et général sans valeur contractuelle.</p>
                    <p>Malgré des mises à jour régulières, le site https://lumera.social/ ne peut être tenu responsable de la modification des dispositions administratives et juridiques survenant après la publication. De même, le site ne peut être tenue responsable de l’utilisation et de l’interprétation de l’information contenue dans ce site.</p>
                    <p>Le site https://lumera.social/ ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter l’ordinateur ou tout matériel informatique de l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement provenant de ce site.</p>
                    ...
                    <h2 class="a-h3">ARTICLE 6 : Liens hypertextes</h2>
                    <p>Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces liens, il sortira du site https://lumera.social/. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles aboutissent ces liens et ne saurait, en aucun cas, être responsable de leur contenu.</p>

                    <h2 class="a-h3">ARTICLE 7 : Cookies</h2>
                    ...
                    <p>Les cookies sont de petits fichiers stockés temporairement sur le disque dur de l’ordinateur de l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site https://lumera.social/. Les cookies ne contiennent pas d’information personnelle et ne peuvent pas être utilisés pour identifier quelqu’un. Un cookie contient un identifiant unique, généré aléatoirement et donc anonyme. Certains cookies expirent à la fin de la visite de l’Utilisateur, d’autres restent.</p>
                    <p>L’information contenue dans les cookies est utilisée pour améliorer le site https://lumera.social/. En naviguant sur le site, L’Utilisateur les accepte.</p>
                    ...
                    <h2 class="a-h3">ARTICLE 8 : Droit applicable et juridiction compétente</h2>
