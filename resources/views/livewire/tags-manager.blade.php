<div class="bg-gray-50 p-2">
    ...
    <div class="flex flex-wrap gap-2 my-1">
        ...
        <div class="">
            <input type=radio wire:model='selected_tag' value="{{ $tag->id }}" id="tag_{{ $tag->id }}" class="hidden peer">
            <label for="tag_{{ $tag->id }}" class="transition border border-gray-900 duration-200 inline-flex first-line:justify-center text-md items-center font-extrabold px-3 py-2 whitespace-nowrap text-gray-900 cursor-pointer bg-gray-50 peer-checked:border-cyan-400 peer-checked:bg-cyan-400 peer-checked:text-gray-50">
                <div class="block">
